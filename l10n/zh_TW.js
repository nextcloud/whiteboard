OC.L10N.register(
    ...
    "Failed to load organization libraries." : "載入組織媒體庫失敗。",
    "Uploaded library \"{name}\"." : "已上傳媒體庫「{name}」。",
    "Organization library uploaded." : "已上傳組織媒體庫。",
    "Failed to upload organization library." : "上傳組織媒體庫失敗。",
    "Delete organization library \"{name}\"? It will no longer appear in users' library panels." : "要刪除組織媒體庫「{name}」嗎？這將不會再出現在使用者的媒體庫面板。",
    "Organization library deleted." : "已刪除組織媒體庫。",
    "Failed to delete organization library." : "刪除組織媒體庫失敗。",
    "Failed to load organization canvases." : "載入組織畫布失敗。",
    "Uploaded canvas \"{name}\"." : "已上傳畫布「{name}」。",
    "Organization canvas uploaded." : "已上傳組織畫布。",
    "Failed to upload organization canvas." : "上傳組織畫布失敗。",
    "Delete organization canvas \"{name}\"? It will no longer appear in the \"New whiteboard\" picker. Boards already created from it keep their content." : "要刪除組織畫布「{name}」嗎？這將不會再出現在「新白板」挑選器。已透過該功能建立的白板將保留其內容。",
    ...
    "Templates shared with everyone in this organization." : "與本組織所有成員分享的範本。",
    "Organization templates require Nextcloud 30 or later. Upgrade to make them available in the \"New whiteboard\" picker." : "組織範本需使用 Nextcloud 30 或更新版本。請升級系統，以便在「新增白板」選單中使用這些範本。",
    "Libraries" : "媒體庫",
    "Shape libraries shown to everyone as read-only sections in the whiteboard library panel. Upload an .excalidrawlib file; its shapes appear in every user’s library alongside their own." : "在白板媒體庫面板中，將形狀媒體庫以唯讀區塊的形式顯示給所有人。上傳一個 .excalidrawlib 檔案；其中的形狀會與每位使用者自己的形狀一同出現在所有使用者的媒體庫中。",
    "Uploading…" : "正在上傳…",
    "Upload library" : "上傳媒體庫",
    "Loading organization libraries…" : "正在載入組織媒體庫……",
    "No organization libraries yet. Upload an .excalidrawlib file to share a set of shapes with everyone." : "目前尚無組織媒體庫。請上傳 .excalidrawlib 檔案，以便與所有人分享一組圖形。",
    "Delete library {name}" : "刪除媒體庫 {name}",
    "Delete" : "刪除",
    "Canvases" : "畫布",
    "Whiteboard canvases available to everyone in the \"New whiteboard\" picker. Upload a .whiteboard file; new boards created from it start with a copy of its content." : "「新增白板」選單中提供供所有人使用的白板畫布。上傳 .whiteboard 檔案；由此建立的新白板將以該檔案內容的副本為基礎。",
    "Upload canvas" : "上傳畫布",
    "Loading organization canvases…" : "正在載入組織畫布……",
    "No organization canvases yet. Upload a .whiteboard file to share a starting board with everyone." : "目前尚無組織畫布。請上傳 .whiteboard 檔案以與所有人分享初始白板。",
    ...
    "Could not load the library \"{name}\"." : "無法載入媒體庫「{name}」。",
    "Enter a library name." : "輸入媒體庫名稱。",
    "Add at least one shape to your library first." : "請先新增至少一個形狀到您的媒體庫。",
    "Organization library saved." : "已儲存組織媒體庫。",
    "Library saved." : "已儲存媒體庫。",
    "A canvas template with this name already exists. Choose a different name." : "已經存在一個同名的畫布範本。請選擇其他名稱。",
    "Could not save library." : "無法儲存媒體庫。",
    "Enter a canvas name." : "輸入畫布名稱。",
    "This whiteboard has no content to save as a canvas." : "此白板沒有可儲存為畫布的內容。",
    "Canvas is too large (max 15 MB)." : "畫布太大了（最大 15 MB）。",
    "Organization canvas published." : "已發佈組織畫布。",
    "Canvas saved to your Templates folder." : "畫布已儲存至您的範本資料夾。",
    "A library with this name already exists. Choose a different name." : "已經存在同名的媒體庫。請選擇其他名稱。",
    "Could not save canvas." : "無法儲存畫布。",
    "Max image size is {max} MB" : "最大影像大小為 {max} MB",
    "My library" : "我的媒體庫",
    "Comments" : "留言",
    "Voting" : "投票",
    "Save as library" : "儲存為媒體庫",
    "Save your current library as a reusable, named library. New whiteboards can start from it, and updates reach every board using it." : "將您目前的媒體庫儲存為可重複使用的命名媒體庫。新的白板可以以此為基礎建立，而更新內容將同步至所有使用該媒體庫的白板。",
    "Library name" : "媒體庫名稱",
    "Save as canvas" : "儲存為畫布",
    "Save a copy of this whiteboard as a canvas. New whiteboards created from it start with its content." : "將此白板儲存為畫布。從該畫布建立的新白板將直接繼承其內容。",
    "Canvas name" : "畫布名稱",
    ...
    "Available to" : "可使用者",
    "Only me" : "僅我",
    "Everyone in the organization" : "組織內的每個人",
    "Saving…" : "正在儲存……",
    "Timer offline" : "計時器離線",
    "Running" : "跑步",
    "Paused" : "暫停",
