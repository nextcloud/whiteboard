OC.L10N.register(
    ...
    "Whiteboard server URL is not configured. Whiteboard requires a separate collaboration server that is connected to Nextcloud." : "Beyaz tahta sunucu adresi yapılandırılmamış. Beyaz tahta uygulaması için, Nextcloud ile bağlantılı ayrı bir işbirliği sunucusu gereklidir.",
    "Nextcloud server could not connect to whiteboard server" : "Nextcloud sunucusu bir beyaz tahta sunucusu ile bağlantı kuramadı",
    ...
    "Whiteboard backend server could not reach Nextcloud: " : "Beyaz tahta arka uç sunucusu Nextcloud sunucusuna erişemedi:",
    "Failed to connect to whiteboard server server status endpoint" : "Beyaz tahta sunucusunun sunucu durumu uç noktası ile bağlantı kurulamadı",
