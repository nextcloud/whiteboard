OC.L10N.register(
    ...
    "Whiteboard settings" : "ئاق دوسكا تەڭشىكى",
    "Whiteboard backend server is configured and connected." : "ئاق دوسكا ئارقا مۇلازىمىتىرى سەپلەنگەن ۋە ئۇلانغان.",
    "Failed to verify the connection:" : "ئۇلىنىشنى دەلىللىيەلمىدى:",
    "Verifying connection…" : "ئۇلىنىشنى دەلىللەۋاتىدۇ…",
    "Whiteboard requires a separate collaboration server that is connected to Nextcloud." : "ئاق دوسكا Nextcloud غا ئۇلانغان ئايرىم ھەمكارلىق مۇلازىمېتىرىنى تەلەپ قىلىدۇ.",
    "See the documentation on how to install it." : "ئۇنى قانداق ئورنىتىش توغرىسىدىكى ھۆججەتلەرنى كۆرۈڭ.",
    "Whiteboard server URL" : "ئاق دوسكا مۇلازىمېتىرى URL",
