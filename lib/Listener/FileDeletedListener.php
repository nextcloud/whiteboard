...
/** @template-implements IEventListener<NodeDeletedEvent|Event> */
/**
 * @psalm-suppress UndefinedClass
 * @psalm-suppress MissingTemplateParam
 */
final class FileDeletedListener implements IEventListener {
	...
	public function handle(Event $event): void {
		if (!($event instanceof NodeDeletedEvent) || !$this->configService->getWhiteboardEnableStatistics()) {
			return;
		}
